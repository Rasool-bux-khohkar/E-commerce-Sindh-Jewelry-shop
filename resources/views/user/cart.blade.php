            ...
            <form action="#" method="post" class="cart style2">
                <table>
                    ...
                    <tbody>
                        ...
                        @endphp
                        <tr data-id="{{ $id }}" class="cart__row border-bottom line1 cart-flex border-top">
                            <td class="cart__image-wrapper cart-flex-item">
                                <a href="#"><img class="cart__image" src="{{ asset('img/'.$details['image']) }}" alt="Product image logo"></a>
                            </td>
                            ...
                            <td class="cart__update-wrapper cart-flex-item text-right">
                                <div class="cart__qty text-center">
                                    <div class="qtyField">
                                        ...
                                        <input class="cart__qty-input qty quantity update-cart" type="text" name="updates[]" id="qty" value="{{ $details['quantity']}}" pattern="[0-9]*">
                                        <a class="qtyBtn plus" href="javascript:void(0);"><i class="icon icon-plus"></i></a>
                                    </div>
                                </div>
                            </td>
                            <td class="text-right small--hide cart-price">
                                <div><span class="money">{{ $details['price'] * $details['quantity'] }}</span></div>
                            </td>
                            <td class="text-center small--hide"><a href="#" class="btn btn--secondary cart__remove remove-from-cart" title="Remove tem"><i class="icon icon anm anm-times-l"></i></a></td>
                        </tr>
                        @endforeach
                        @endif
                    </tbody>
                ...
                <div class="col-12 col-sm-12 col-md-5 col-lg-5 cart__footer">
                    <div class="solid-border">	
                      <div class="row border-bottom pb-2">
                        ...
                        <span class="col-12 col-sm-6 text-right"><span class="money">RS. {{ $total }}</span></span>
                      </div>
                      ...
                      <div class="row border-bottom pb-2 pt-2">
                        ...
                        <span class="col-12 col-sm-6 text-right">RS. {{ $charges }}</span>
                      </div>
                      <div class="row border-bottom pb-2 pt-2">
                        <span class="col-12 col-sm-6 cart__subtotal-title"><strong>Grand Total</strong></span>
                        <span class="col-12 col-sm-6 cart__subtotal-title cart__subtotal text-right"><span class="money">RS. {{ $total+ $charges }}</span></span>
                      </div>
                      ...
                      <a href="/checkout">
                          <button type="submit" class="btn btn--small-wide checkout" name="checkout">Proceed To Checkout</button>
                      </a>
